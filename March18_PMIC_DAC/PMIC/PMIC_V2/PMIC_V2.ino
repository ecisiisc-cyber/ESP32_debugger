...
void setup() {
  ...
  Serial1.println("Test 6- dechain and set 2 volt to  the bucks4 ");
...
//------------------------
//+3.01 make buck 4 to be 3 v
  writeReg(0x238, 0xB8);   //B8 3 V 90 2V 50 1V C0 3.2V C4 3.3V
  writeReg(0x237, 0x90);
  writeReg(0x231, 0x81);  //buck 4
//====================

//+3.01 make buck 7 to be 1 v
  writeReg(0x250, 0x50);   //B8 3 V 90 2V 50 1V C0 3.2V C4 3.3V
  writeReg(0x24F, 0x50);
  writeReg(0x249, 0x81);  //buck 7
//====================
//+3.01 make buck 5 to be 2 v
  writeReg(0x23F, 0x90);   //B8 3 V 90 2V 50 1V C0 3.2V C4 3.3V
  writeReg(0x240, 0x90);
  writeReg(0x239, 0x81);  //buck 7
//====================
  //--------------------------------------
  // 4. Set LDO1 = 2.0V
  //--------------------------------------
